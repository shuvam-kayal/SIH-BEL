...
export class UsersServiceImpl implements UsersService {
  ...
  private async submit(type: "IDENTITY_CREATE" | "ROLE_ASSIGN" | "WALLET_ACTIVATE" | "WALLET_REVOKE" | "GRANT_CREATE" | "GRANT_REVOKE", actor: Identity, payload: Record<string, unknown>): Promise<void> {
