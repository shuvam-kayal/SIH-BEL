...
export interface IdentityRepository { findById(id: string): Promise<Identity | null>; findByEmployeeId(employeeId: string): Promise<Identity | null>; save(identity: Identity): Promise<void>; }
...
export interface CredentialRepository { findDeviceId(verifier: string): Promise<string | null>; save(verifier: string, deviceId: string): Promise<void>; revoke(verifier: string): Promise<void>; }
